<template>
    <div id="resolved" style="width: 120px; height: 180px;">
        <div class="col" style="margin: 8px;">
            <canvas id="resolvedGrafico"></canvas>
            <h6 style="text-align: center;margin-top: 0px;">{{ "Resolved" | captaliza }}</h6>
        </div>
    </div>
</template>
...
export default {
    props: ['result'],
    mounted() {
        new Chart(document.getElementById("resolvedGrafico"), {
            type: 'doughnut',
            data: {
                datasets: [{
